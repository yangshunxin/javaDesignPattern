package org.example.visitor.company;
...
public class VisitorProducer {
    public static void main(String[] args) throws IOException {
        ...
        // dir
        String imageDir = System.getProperty("user.dir")+"/target/classes";
        File folder = new File(imageDir);
        if (!folder.exists()){
            System.out.println(imageDir + " not exist");
        } else {
            System.out.println(imageDir + " exist");
        }
...
//        String FileName1 = "src/visitor/Picture/" + Cuprum + ".jpg";
        String FileName1 =  "target/classes/"+ Cuprum + ".jpg";
        String FileName2 =  "target/classes/"+ paper + ".jpg";
...
class SetMaterial {
    ...
    public String accept(Company visitor) {
        ...
        while (i.hasNext()) {
            tmp.append(((Material) i.next()).accept(visitor)).append(" ");
        }
